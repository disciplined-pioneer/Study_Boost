...
async def login_handler(message: types.Message, state: FSMContext):
    ...
    if can_use == 2:
        message_text = 'Добро пожаловать! Доступ к платформе открыт без всяких ограничений 😊'
    elif can_use == 1:
        message_text = 'Добро пожаловать! Ваша подписка истекла, и доступен только ограниченный функционал 🙂'
    else:
        message_text = 'Добро пожаловать! Вам доступен только ограниченный функционал 🙂'

    await message.reply(message_text, reply_markup=platform_menu)
