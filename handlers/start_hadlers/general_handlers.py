...
async def login_handler(message: Message):
    ...
    # Добавляем "Premium" только если пользователей <= 55
    user_count = await count_users()
    if user_count <= 55:
        text += "💎 <b>Premium:</b> <i>пожизненная стоимость в 25 ₽ для первых 50 пользователей</i> 🔥\n\n"
