...
async def login_handler(message: Message):
    await message.answer(
        ...
        "📅 <b>Basic Two Month:</b> подписка на 2 месяца — <b>90 ₽</b>\n\n"
        "📅 <b>Three Month:</b> подписка на 3 месяца — <b>120 ₽</b>\n\n"
        "💎 <b>Premium:</b> <i>пожизненная стоимость в 25р для первых 50 пользователей</i> 🔥\n\n"
        "Для оформления подписки, пожалуйста, переведите соответствующую сумму на:\n\n"
        "<b>Карта 🍀</b>: \"9104 0160 3996 20160\"\n"
        "<b>Переводила 📞</b>: \"+373-77-544-985 ( Максим Ш. )\"\n\n"
        "После оплаты зарегистрируйтесь и отправьте скриншот об оплате",
        parse_mode="HTML"
    )
