...
from handlers.platform_handlers.material_handlers.search_materials import router as search_material_router  # Роутер для поиска материалов
...
async def main():
    ...
    dp.include_router(search_material_router)  # Включаем роутер для поиска материалов
